...
export const PreviewMixin = {
    ...
    drawCoordinateGizmo(ctx, point, selectedAxis = null) {
        ...
        ctx.save();
        ctx.globalAlpha = selectedAxis === 'Z' ? 1.0 : 0.35; // Pasif ise çok soluk
        ...
        ctx.save();
        ctx.globalAlpha = selectedAxis === 'X' ? 1.0 : 0.35; // Pasif ise çok soluk
        ...
        ctx.save();
        ctx.globalAlpha = selectedAxis === 'Y' ? 1.0 : 0.35; // Pasif ise çok soluk
