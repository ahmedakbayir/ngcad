// Test script for XML parser - second file
...
// Read test XML file
const xmlContent = readFileSync('./test-import-2.xml', 'utf-8');

try {
    console.log('Parsing XML (second format)...\n');
    ...
    writeFileSync('./test-output-2.json', JSON.stringify(projectData, null, 2));
    console.log('\n✓ Output written to test-output-2.json');
